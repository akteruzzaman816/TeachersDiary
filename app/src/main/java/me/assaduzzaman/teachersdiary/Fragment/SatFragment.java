...
public class SatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        catLayout=v.findViewById(R.id.sat_cat);

        recyclerView=v.findViewById(R.id.recyclerView_sat);
       ...
       String sirCode=preferences.getString("code","0");
        ...
        try {
            ...
            Cursor cursor = db.rawQuery("select * from "+Config.TABLE_ROUTINE+" where "
                    +Config.COLUMN_ROUTINE_DAY+"=? and "+Config.COLUMN_TEACHER_CODE+"=?" ,new String [] {"Saturday",sirCode});
