...
public class TuesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.tues,container,false);


        catLayout=v.findViewById(R.id.tues_cat);

        recyclerView=v.findViewById(R.id.recyclerView_tues);
    ...
    public  ArrayList<Routine> getRoutinetList(Context context) {
        ...
        try {
            ...
            Cursor cursor = db.rawQuery("select * from "+ Config.TABLE_ROUTINE+" where "
                    +Config.COLUMN_ROUTINE_DAY+"=? and "+Config.COLUMN_TEACHER_CODE+"=?" ,new String [] {"Tuesday",sirCode});
