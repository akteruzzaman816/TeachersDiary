...
public class MonFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        catLayout=v.findViewById(R.id.mon_cat);

        recyclerView=v.findViewById(R.id.recyclerView_mon);
    ...
    public  ArrayList<Routine> getRoutinetList(Context context) {
        ...
        try {
            ...
            Cursor cursor = db.rawQuery("select * from "+ Config.TABLE_ROUTINE+" where "
                    +Config.COLUMN_ROUTINE_DAY+"=? and "+Config.COLUMN_TEACHER_CODE+"=?" ,new String [] {"Monday",sirCode});
